...
from app.application.services.scrapper.MonitoringReportService import MonitoringReportService
...
class Dependencies(containers.DeclarativeContainer):
    ...
    monitoring_report_rep = providers.Factory(
         MonitoringReportRep,
    ...
    monitoring_report_service: providers.Factory[IMonitoringReportService] = providers.Factory(
